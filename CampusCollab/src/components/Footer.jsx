        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h2  className="text-xl font-semibold mb-4">Quick Links</h2>
              ...
              <a href="/aboutus" className="block text-gray-400 hover:text-white transition-colors duration-300">About Us</a>
              <a href="/allworks" className="block text-gray-400 hover:text-white transition-colors duration-300">Explore all projects</a>
              <a href="/contactus" className="block text-gray-400 hover:text-white transition-colors duration-300">Contact Us</a>
          </div>
          <div className="space-y-4">
